...
\begin{abstract}
  ...
  memory search to create a parallel best-first style search to be
  used to more quickly solve smaller search domains.  Our new
...
solve problems more quickly.  Processors are not getting any faster so
AI researchers must begin finding methods of using parallelism for
speed.  For this work our goal was to use parallelism to solve
heuristic search problems as fast as possible.
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=3in]{images/tiles-time-random-7-2.eps}
