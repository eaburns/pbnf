...
\@x{}\moduleLeftDash\@xx{ {\MODULE} GridWorld}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{GridWorld} is an instance of the \ensuremath{NBlockGraph} module
 where the \ensuremath{NBlock
 } protection scopes are defined by \ensuremath{GridWorld} rows modulo a
 certain
 value. Here, this is modeled by giving \ensuremath{NBlocks} each a unique
 \ensuremath{ID}, and
 the neighbor \ensuremath{NBlocks} with \ensuremath{IDs} of 1 greater and 1
 less are in the
 protection scope.
\end{cpar}%
\end{lcom}%
...
\par\vspace{8.0pt}%
\@x{ {\CONSTANTS}}%
\@x{\@s{32.8} NNBlocks ,\,\@s{28.7}}%
\@y{\@s{0}%
 The number of \ensuremath{NBlocks
}}%
\@xx{}%
\@x{\@s{32.8} NProcs ,\,\@s{39.83}}%
\@y{\@s{0}%
 The number of processors
}%
\@xx{}%
\@x{\@s{32.8} None ,\,\@s{48.35}}%
\@y{\@s{0}%
 No \ensuremath{NBlock}.
}%
\@xx{}%
\@x{\@s{32.8} Search ,\,\@s{42.86}}%
\@y{\@s{0}%
 Process will search next.
}%
\@xx{}%
\@x{\@s{32.8} NewBlock ,\,\@s{28.72}}%
\@y{\@s{0}%
 Process will get a new \ensuremath{NBlock}.
}%
\@xx{}%
\@x{\@s{32.8} GetBlock ,\,\@s{31.74}}%
\@y{\@s{0}%
 Process tries to get the next free block.
}%
\@xx{}%
\@x{\@s{32.8} Waiting\@s{42.31}}%
\@y{\@s{0}%
...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Neighboring \ensuremath{NBlocks}.
\end{cpar}%
\end{lcom}%
 \@x{ NeighborsOf ( NBlocks ,\, b ) \.{\defeq} \{ i \.{\in} \{ b \.{-} 1 ,\, b
 \.{+} 1 \} \.{:} i \.{\in} NBlocks \}}%
\par\vspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Predecessor \ensuremath{NBlocks}.
\end{cpar}%
\end{lcom}%
\@x{ GridPredsOf ( NBlocks ,\, b ) \.{\defeq} NeighborsOf ( NBlocks ,\, b )}%
\par\vspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Successor \ensuremath{NBlocks}.
\end{cpar}%
\end{lcom}%
\@x{ GridSuccsOf ( NBlocks ,\, b ) \.{\defeq} NeighborsOf ( NBlocks ,\, b )}%
\par\vspace{8.0pt}%
\@x{ {\INSTANCE} NBlockGraph}%
\@x{ {\WITH} PredsOf \.{\leftarrow} GridPredsOf ,\,}%
\@x{\@s{30.97} SuccsOf \.{\leftarrow} GridSuccsOf}%
\par\vspace{8.0pt}%
\@x{ GridInit \.{\defeq} \.{\land} Init}%
\@x{\@s{55.83} \.{\land} NBlocks \.{\neq} \{ \}}%
\@x{\@s{55.83} \.{\land} \A\, i \.{\in} NBlocks \.{:} i \.{\in} Nat}%
\par\vspace{8.0pt}%
\@x{ Prog \.{\defeq} \.{\land} GridInit}%
\@x{\@s{39.46} \.{\land} {\Box} [ Next ]_{ Vars}}%
\@x{\@s{39.46} \.{\land} Fairness}%
\par\vspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
