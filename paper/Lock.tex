...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Lock}\moduleRightDash\@xx{}%
\@x{}%
\@y{\@s{0}%
 This implements a starvation free, mutual exclusion lock.
}%
\@xx{}%
\par\vspace{8.0pt}%
\@x{ {\EXTENDS} FiniteSets ,\, Naturals ,\, Sequences}%
\par\vspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 The type for a lock.
...
\@xx{}%
\@x{ LockType ( Set ) \.{\defeq} [ has \.{:} {\SUBSET} Set ,\,}%
\@x{\@s{84.69} wait \.{:} Seq ( Set ) ]}%
\par\vspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 An invariant for locks.
}%
\@xx{}%
\@x{ LockInvariant ( lock ) \.{\defeq} Cardinality ( lock . has ) \.{\leq} 1}%
\par\vspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Unlocked \.{\defeq} [ has \.{\mapsto} \{ \} ,\,}%
\@x{\@s{61.31} wait \.{\mapsto} {\langle} {\rangle} ]}%
\par\vspace{16.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ IsLocked ( l ) \.{\defeq} l . has \.{\neq} \{ \}}%
\par\vspace{16.0pt}%
\@x{}%
\@y{\@s{0}%
 Test if the given \ensuremath{i} has the lock.
}%
\@xx{}%
\@x{ HasLock ( l ,\, i ) \.{\defeq} i \.{\in} l . has}%
\par\vspace{16.0pt}%
\@x{}%
\@y{\@s{0}%
 Test if \ensuremath{i} is waiting on the lock.
}%
\@xx{}%
\@x{ IsWaitingOnLock ( lock ,\, i ) \.{\defeq}}%
\@x{\@s{8.2} {\IF} lock . wait \.{=} {\langle} {\rangle}}%
\@x{\@s{8.2} \.{\THEN} {\FALSE}}%
 \@x{\@s{8.2} \.{\ELSE} \E\, j \.{\in} 1 \.{\dotdot} Len ( lock . wait ) \.{:}
 lock . wait [ j ] \.{=} i}%
\par\vspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
 \ensuremath{i} Tries to get lock \ensuremath{l}. If it gets the lock, then it
 is the
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
singleton value of the \ensuremath{has\_lock} field.
\end{cpar}%
\end{lcom}%
 \@x{ Lock ( l ,\, i ) \.{\defeq} {\IF} IsWaitingOnLock ( l ,\, i ) \.{\lor}
 HasLock ( l ,\, i )}%
\@x{\@s{61.08} \.{\THEN} {\UNCHANGED} {\langle} l {\rangle}}%
\@x{\@s{61.08} \.{\ELSE} {\IF} IsLocked ( l )}%
 \@x{\@s{92.40} \.{\THEN} l \.{'} \.{=} [ l {\EXCEPT} {\bang} . wait \.{=}
 Append ( @ ,\, i ) ]}%
 \@x{\@s{92.40} \.{\ELSE} l \.{'} \.{=} [ l {\EXCEPT} {\bang} . has \.{=} \{ i
 \} ]}%
\par\vspace{16.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Unlock ( l ) \.{\defeq} \.{\land} IsLocked ( l )}%
\@x{\@s{60.74} \.{\land} {\IF} l . wait \.{=} {\langle} {\rangle}}%
 \@x{\@s{71.85} \.{\THEN} l \.{'} \.{=} [ l {\EXCEPT} {\bang} . has \.{=} \{
 \} ]}%
 \@x{\@s{71.85} \.{\ELSE} l \.{'} \.{=} [ has \.{\mapsto} \{ Head ( l . wait )
 \} ,\,}%
\@x{\@s{125.67} wait \.{\mapsto} Tail ( l . wait ) ]}%
\par\vspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
Remove the first waiting process without them getting the lock.
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
This is a fault.
\end{cpar}%
\end{lcom}%
 \@x{ CancelWait ( l ) \.{\defeq} \.{\land} l . wait \.{\neq} {\langle}
 {\rangle}}%
 \@x{\@s{81.82} \.{\land} l \.{'} \.{=} [ l {\EXCEPT} {\bang} . wait \.{=}
 Tail ( @ ) ]}%
\par\vspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
